...
| [`/llm/MODELS.md`](https://auth.codesena.me/documents/llm/MODELS.md) | [`llm-docs/MODELS.md`](file:///d:/Code%20PlayGround/PROJECTS/AUTH_MODULE/llm-docs/MODELS.md) | Mermaid ER diagrams, table schemas, and architecture flowcharts. | Visualizing database relationships, SQL schemas, and token lifecycles. |
...
| [`/llm/FAQ.md`](https://auth.codesena.me/documents/llm/FAQ.md) | [`llm-docs/FAQ.md`](file:///d:/Code%20PlayGround/PROJECTS/AUTH_MODULE/llm-docs/FAQ.md) | FAQ & architectural comparison vs FastAPI-Users, Auth0, Supabase. | Architectural questions, security justification, and advantages. |
...
| [`/api/log_route.md`](https://auth.codesena.me/documents/api/log_route.md) | [`api_docs/log_route.md`](file:///d:/Code%20PlayGround/PROJECTS/AUTH_MODULE/api_docs/log_route.md) | `/log` primary logs, snapshots, resets, and SSE streams. | Superadmin logging endpoints and real-time event streaming. |
| [`/api/log_frontend_guide.md`](https://auth.codesena.me/documents/api/log_frontend_guide.md) | [`api_docs/log_frontend_guide.md`](file:///d:/Code%20PlayGround/PROJECTS/AUTH_MODULE/api_docs/log_frontend_guide.md) | Frontend logging guide, TypeScript types, SSE streams, React hook & UI. | Building frontend log viewers, streaming feeds, and admin log dashboards. |
...
| [`/sdk/logging/logging.md`](https://auth.codesena.me/documents/sdk/logging/logging.md)<br>[`/sdk/logging/logging.py`](https://auth.codesena.me/documents/sdk/logging/logging.py) | [`usage/logging/`](file:///d:/Code%20PlayGround/PROJECTS/AUTH_MODULE/usage/logging/) | `auth.log` (`LogService`) | Centralized structured JSONL logging, snapshot management, and live SSE streaming. |
